...
import FlickAnimation from "./lib/FlickAnimation";
...
const MINIMUM_DISTANCE_THRESHOLD = 10.24;
...
export default class SlidingUpPanel extends React.Component {
  ...
  _onPanResponderRelease(evt, gestureState) {
    ...
    if (this._animatedValueY > -197) {
      this.transitionTo(0);
      this._isAtTop = false;
      this.props.setSliderToTop(false);
    } else if (this._animatedValueY < visibleHeight - 10 && this._isAtTop) {
      this.transitionTo(this.props.photoViewHeight);
      this._isAtTop = false;
      this.props.setSliderToTop(false);
    } else if (this._animatedValueY < -203 && !this._isAtTop) {
      this.transitionTo(visibleHeight);
      this._isAtTop = true;
      this.props.setSliderToTop(true);
    }
